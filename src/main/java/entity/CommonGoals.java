...
public class CommonGoals {
    ...
    public  boolean checkGoal7(Shelf shelf){ return shelf.checkRowSecondGoal(); }           // Settimo obiettivo
    public  boolean checkGoal8(Shelf shelf){ return shelf.checkDiagonal(); }                // Ottavo obiettivo
    public  boolean checkGoal9(Shelf shelf){ return shelf.checkTower(); }                   // Nono obiettivo
    public  boolean checkGoal10(Shelf shelf){ return shelf.checkCube(); }                   // Decimo obiettivo
    public  boolean checkGoal11(Shelf shelf){ return shelf.checkCoppie(); }                 // Undicesimo obiettivo
    public  boolean checkGoal12(Shelf shelf){ return shelf.checkTetris(); }                 // Dodicesimo obiettivo
